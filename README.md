...
Server-side routing will go to the server to make changes and refresh the page, while client-side routing handles the routing data on the javascript. 
...
GET, POST, PUT, and DELETE are the methods.

- [ ] Mention three tools we can use to make AJAX requests.

fetch, .then, and .catch are three tools.
